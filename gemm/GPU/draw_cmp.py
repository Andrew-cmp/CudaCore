...
# 读取 CSV 文件（跳过表头）
data2 = np.genfromtxt('/home/houhw/cuda_learning_practice_and_notes/gemm/GPU/build/sgemm_benchmark_v3.csv', delimiter=',', skip_header=1)
data1 = np.genfromtxt('/home/houhw/cuda_learning_practice_and_notes/gemm/GPU/build/sgemm_benchmark_v4.csv', delimiter=',', skip_header=1)
